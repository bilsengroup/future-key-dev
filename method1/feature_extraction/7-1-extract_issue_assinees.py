...
with open("7-issues_data/query_Issue_Assignees.graphql", "r") as f:
    query = f.read()
...
while True:
    ...
    while True:
        try:
            ...
            with open("7-issues_data/result_temp_issue_Assignees.json", "w", encoding="utf-8") as f:
...
with open("7-issues_data/7-1-result_issue_Assignees.json", "w", encoding="utf-8") as f:
    f.write(json.dumps(result, indent=4, sort_keys=False))
