...
with open("7-issues_data/query_Issues_comments.graphql", "r") as f:
    query = f.read()
...
while True:
    ...
    while True:
        try:
            ...
            with open("7-issues_data/result_temp_issue_Comments.json", "w", encoding="utf-8") as f:
    ...
    if response.status_code == 200:
        ...
        with open("result_temp_issue_Comments.json", "w", encoding="utf-8") as f:
            f.write(json.dumps(result, indent=4, sort_keys=False))
...
with open("7-issues_data/7-2-result_issue_comments_.json", "w", encoding="utf-8") as f:
    f.write(json.dumps(result, indent=4, sort_keys=False))
