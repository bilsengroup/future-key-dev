...
from config import root_name , excel_file, apply_pca
import applying_pca_to_data as custom_pca
...
# Compute average scores using Random Forest Classifier and 10-fold cross-validation
mean_scores_RF = compute_scores_per_fold(cv_stratified, X, y, RandomForestClassifier(n_estimators=100, random_state=42))
main_file_name = 'results_' + root_name

e.update_excel(main_file_name, "RF", mean_scores_RF)
