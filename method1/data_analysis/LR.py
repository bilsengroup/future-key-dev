...
# Compute average scores using Logistic Regression and 10-fold cross-validation
mean_scores_lr = compute_scores_per_fold(cv_stratified, X, y, LogisticRegression(max_iter=1000))
main_file_name = 'results_' + root_name
e.update_excel(main_file_name, "LR", mean_scores_lr)
